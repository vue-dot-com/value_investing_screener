...
Original file is located at
    https://colab.research.google.com/drive/1xUk-BGKArp0BTSbHWIk5ow6sQaT70VAr
"""
...
###########################################################
#RUN ONLY IF USING COLAB AND STORED THE CSV FILES IN DRIVE#
###########################################################
...
file_id = '1SexUUiAEbiWKDi2GP0xcRjZlCcYTy4hm'
downloaded = drive.CreateFile({'id': file_id})
print('Downloaded content "{}"'.format(downloaded.GetContentString()))
downloaded.GetContentFile('stocks.csv') 
############################################################

stocksFile = open('stocks.csv')
stocksReader = csv.reader(stocksFile)
stocksData = list(stocksReader)
...
quote = list([])
capitalization = list([])
for i in range (1,len(stocksData)):
    ticker.append(stocksData[i][0])
    company.append(stocksData [i][1])
    sector.append(stocksData[i][9])
    industry.append(stocksData[i][10])
    capitalization.append(stocksData[i][5])
